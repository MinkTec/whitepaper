...
The gap is not confined to basic science.
SPINE20, a global advocacy alliance of 38 professional spine societies that produces
evidence-informed policy recommendations for G20 governments, stated in its 2025
Cape Town recommendations that musculoskeletal and spine conditions ``remain
under-recognised in health benefits, metrics, and clinic workflows'', and identified
the absence of continuous monitoring data as a systemic barrier to evidence-based
policymaking and longitudinal outcome tracking \cite{spine20_2025}.
The same consensus document calls for adding objective functional improvement
metrics --- such as return-to-work rates and posture-load indicators --- to routine
health-system dashboards as a policy priority.
...
The downstream consequence is a persistent evidential gap: an umbrella review of
41 systematic reviews found no consensus on whether specific spine postures or
physical exposures cause \ac{LBP} --- association has been documented, but the
absence of continuous real-world kinematic data prevents causal inference
\cite{swain2020}.

\begin{factboxlavender}
    41 systematic reviews, no consensus --- the core barrier is the absence of
    instruments capable of measuring real-world spinal kinematics continuously,
...
uncomfortable for participants and difficult to synchronise reliably over extended
recording periods.
