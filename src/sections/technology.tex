...
\begin{factboxfire}
    Curvature is measured directly --- not integrated from angular velocity.
    Drift does not accumulate, regardless of recording duration.
\end{factboxfire}
...
(three-axis accelerometer and three-axis gyroscope) is fixed
...
The detailed implementation of the DH reconstruction is described in \cref{sec:software}.
...
The FlexTail sensor strip and its electronics module detach from the shirt as a
single unit, leaving a plain compression garment that tolerates standard machine
laundering without restriction.
This architecture sidesteps the durability problems endemic to conventional smart
textiles, where conductive yarns delaminate, resistive traces crack, and embedded
electronics corrode after repeated wash cycles \cite{rotzler2021, stoppa2014}.
Because the sensor never enters the wash, its printed strain-gauge traces and
mechanical substrate are unaffected by detergents, heat, or mechanical agitation,
and the garment itself is treated no differently from ordinary athletic wear.
